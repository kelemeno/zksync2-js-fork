...
interface IStateTransitionChainInterface extends ethers.utils.Interface {
  functions: {
    ...
    "bridgehubRequestL2Transaction(address,address,uint256,uint256,bytes,uint256,uint256,bytes[],address)": FunctionFragment;
    "commitBatches(tuple,tuple[])": FunctionFragment;
    "executeBatches(tuple[])": FunctionFragment;
    "executeChainIdUpgrade(tuple,tuple,uint256)": FunctionFragment;
    ...
    "getStateTransition()": FunctionFragment;
    ...
    "initialize(uint256,address,address,address,tuple,bytes32,bytes32,bytes32,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "executeChainIdUpgrade",
    values: [
      {
        facetCuts: {
          facet: string;
  ...
  events: {
    ...
    "SetChainIdUpgrade(tuple,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetChainIdUpgrade"): EventFragment;
...
export class IStateTransitionChain extends Contract {
  ...
  functions: {
    ...
    "executeChainIdUpgrade((tuple[],address,bytes),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[4],bytes,bytes,uint256[],bytes,bytes),uint256)"(
      _diamondCut: {
        facetCuts: {
          facet: string;
          action: BigNumberish;
    ...
    getStateTransition(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    "initialize(uint256,address,address,address,(bytes32,bytes32,bytes32),bytes32,bytes32,bytes32,uint256)"(
      _chainId: BigNumberish,
      _bridgehubChainContract: string,
      _governor: string,
      _verifier: string,
  ...
  getStateTransition(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getStateTransition(overrides?: CallOverrides): Promise<BigNumber>;
